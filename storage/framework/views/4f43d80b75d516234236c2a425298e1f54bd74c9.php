        ...
        <div class="container mb-5">
            <div class="d-flex align-items-center py-4 header">
                ...
                <h4 class="mb-0 ml-3"><strong>Laravel</strong>
                    Telescope<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?></h4>
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <router-link tag="button" to="/monitored-tags" class="btn btn-outline-primary" active-class="active"
                        title="Monitoring">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon fill-primary">
                            <path
            ...
            <div class="row mt-4">
                <div class="col-2 sidebar">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <router-link active-class="active" to="/client-requests"
                                class="nav-link d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path
...
</html><?php /**PATH C:\laragon\www\RealGlit\vendor\laravel\telescope\src/../resources/views/layout.blade.php ENDPATH**/ ?>