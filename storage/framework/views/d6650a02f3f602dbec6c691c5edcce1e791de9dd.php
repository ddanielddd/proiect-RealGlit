    ...
    <form action="/profile/<?php echo e($user->id); ?>" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                    <label for="description" class="col-md-4 col-form-label">Descriere</label>
                ...
                <div class="form-group row">
                    <label for="url" class="col-md-4 col-form-label">Link Website</label>
                ...
                <div class="row">
                    <label for="image" class="col-md-4 col-form-label">Imagine de Profil</label>
                ...
                <div class="row pt-4">
                    <button class="btn btn-dark">Salveaza Profilul</button>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\RealGlit\resources\views/profiles/edit.blade.php ENDPATH**/ ?>