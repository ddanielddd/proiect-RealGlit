                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('register'), false); ?>"><?php echo e(__('Înregistrare'), false); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php else: ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="/profile/<?php echo e(Auth::user()->id, false); ?>/edit">Editează Profilul</a>
                                    <hr>
                                    <a class="dropdown-item" href="<?php echo e(route('logout'), false); ?>"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        <?php echo e(__('Deconectează'), false); ?>
